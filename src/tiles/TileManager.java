...
public class TileManager {
    GamePanel gp;
    // cấu trúc dữ liệu lưu các dạng bản đồ
    public Tile[] tile;
    /* mảng 2 chiều để lưu trữ các số tương ứng với từng dạng bản đồ
    được lưu trong tệp txt
     */
...
//            tile[6] = new Tile();
//            tile[6].image = ImageIO.read(getClass().getResourceAsStream("/tile/trunk.png"));
        } catch (IOException e) {
        ...
        try {
            ...
            while (col < gp.maxWorldCol && row < gp.maxWorldRow) {
                ...
                while (col < gp.maxWorldCol) {
                    /*
                    lấy ra các ký tự trong file txt và gán nó vào mảng kiểu String
                    sau đó ép kiểu để đưa vào mảng 2 chiều
                     */
